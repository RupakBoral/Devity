...
const NavBar = () => {
  ...
  return (
    user !== null && (
      <div className="navbar bg-base-200 z-50 m-0 px-0 flex items-center border-b-2 border-accent gap-2 lg:gap-6 md:gap-6 justify-evenly md:justify-around lg:justify-around">
